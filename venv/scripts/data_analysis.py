...
## For ETF Data
et_funds_data = sc.textFile("/Users/sharadbagal/BigData/Research/BNY-Code-Challenge/data/Fund_Data_2.txt").map(lambda d:(d.split("\t"))).toDF(["SHARECLASS_ID","SHARECLASS_NAME","FUND_NAME","CATEGORY","SHARPE_RATIO_1Y","SHARPE_RATIO_3Y","SHARPE_RATIO_5Y","BETA_1Y","BETA_3Y","BETA_5Y","INFO_RATIO_3Y","INFO_RATIO_5Y"])
...
result.coalesce(1).write.format("com.databricks.spark.csv").options(delimiter=',').option("header","true").save("/Users/sharadbagal/BigData/Research/BNY-Code-Challenge/data/result")
